...
export default function Header({ stats }) {
  return (
    <div className="bg-black/40 backdrop-blur-md border-b border-white/10 flex flex-col lg:flex-row justify-center lg:justify-between px-4 lg:px-8 py-3 lg:py-4 gap-3">
